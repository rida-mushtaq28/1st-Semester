...
void storeCheckInOutInFile(int checkInOut)
{
   fstream file1;
   file1.open("bookings.txt", ios::app);
   file1 << "Number of Stays:" << endl;
   file1 << checkInOut << endl;
   file1.close();
}
...
void storeTypeofRoomsInFile()
{
   fstream file1;
   file1.open("bookings.txt", ios::app);
   file1 << "Types of Rooms:" << endl;
   file1 << typeofRoom << endl;
   file1.close();
}
...
void storeFeedbackInFile(string feedback)
{
   ...
   file1 << "Feedback by the Customer:" << endl;
   file1 << feedback << endl;
   file1.close();
}
void readDataFromBookings()
